...
export function TimeControls({
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-3 mt-3">
      <div className="flex items-center gap-3">
        ...
        <span className="text-sm font-medium text-slate-700 dark:text-slate-300 min-w-[60px] text-right">
          {timeLabel}
        </span>
      </div>
